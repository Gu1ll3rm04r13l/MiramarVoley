...
insert into players (id, club_id, nombre, posicion, numero_actual, numero_nuevo, estado, foto_url, orden) values ('p08', 'miramar', 'Guillermo Ariel del Fresno', 'Punta y Central', 12, 20, 'activo', NULL, 8) on conflict (id) do nothing;
