...
insert into players (id, club_id, nombre, posicion, numero_actual, numero_nuevo, estado, foto_url, orden) values ('p08', 'miramar', 'Guillermo Ariel del Fresno', 'Punta', 12, 20, 'activo', NULL, 8) on conflict (id) do nothing;
...
insert into matches (id, division_id, jornada, fecha, hora, local, visitante, sets_local, sets_visitante, parciales, estado, nota) values ('m09', 'ascenso', 'Fecha 11', '2026-06-13', '19:00', 'ATLE GESELL', 'MIRAMAR V', NULL, NULL, NULL, 'proximo', NULL) on conflict (id) do nothing;
...
insert into match_reports (id, match_id, torneo, categoria, fecha, duracion_min, sets_local, sets_visitante, equipo_puntos, equipo_errores, efectividad, rival_nombre, rival_puntos, rival_errores, resultado_por_set, fundamentos, destacados) values ('r01', 'm01', 'Fecha 1 Apertura', 'Primera Masculina', '2026-03-29', 75, 3, 0, 75, 24, 70.0, 'CAI DOLORES', 48, 36, '[{"set": 1, "local": 25, "visitante": 8}, {"set": 2, "local": 25, "visitante": 19}, {"set": 3, "local": 25, "visitante": 21}]'::jsonb, '{"ataque": 60, "recepcion": 38, "saque": 45, "bloqueo": 58, "defensa": 63, "contraataque": 68}'::jsonb, '{"mejorRendimiento": {"jugador": "Alex Angel", "num": 18, "rating": 75}, "menorRendimiento": {"jugador": "Gastón Espindola", "num": 15, "rating": 35}, "mejorSacador": {"jugador": "Matias Gerber", "num": 17, "saque": 56}}'::jsonb) on conflict (id) do nothing;
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 8, 'Francisco Pomares', 42, NULL, 88, 50, NULL, 84, 2, 10, 66);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 2, 'Rodrigo Perez', 50, NULL, 50, NULL, NULL, NULL, 1, 1, 50);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 7, 'Braian Aramayo', 52, NULL, NULL, NULL, NULL, NULL, 0, 1, 52);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 10, 'Elias Gonzalez', 50, NULL, NULL, 100, NULL, 58, 1, 2, 69);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 17, 'Matias Gerber', 56, 75, 46, 50, NULL, 72, 3, 7, 60);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 5, 'Nicolas Krasnopolski', 50, NULL, 63, 50, NULL, NULL, 0, 2, 54);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 4, 'Carlos Ledesma', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 18, 'Alex Angel', NULL, NULL, NULL, NULL, 75, NULL, 0, 2, 75);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 9, 'Elio Contreras', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 1, 'Esteban Blasco', 25, NULL, NULL, 83, NULL, NULL, 1, 1, 54);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 3, 'Fausto Caielli', 25, NULL, 50, 50, 25, 46, 3, -2, 39);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 15, 'Gastón Espindola', 13, 0, 58, 0, 75, 65, 5, -1, 35);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 14, 'Guido Grimaldi', 50, NULL, NULL, NULL, NULL, NULL, 0, 0, 50);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 19, 'Isaac Ceballos', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 13, 'Pablo Medina', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 11, 'Enzo Grimaldi', 50, NULL, 75, NULL, NULL, 75, 0, 2, 67);
insert into report_players (report_id, num, nombre, saq, rec, ata, bloq, def, cata, err, mas_menos, rating) values ('r01', 20, 'Ariel Del Fresno', 50, NULL, 58, NULL, NULL, NULL, 0, 1, 54);
